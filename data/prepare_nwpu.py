...
# parser.add_argument('--data_path', type=str, default='/media/jiliang/新加卷1/01数据/02人群密度数据/NWPU_BSDA',
#                     help='the data path of NWPU')

parser.add_argument('--data_path', type=str, default='/media/NWPU_BSDA',
                    help='the data path of NWPU')
